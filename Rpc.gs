/**
 * ==========================================================
 *  Rpc.gs — Jembatan REST untuk App Hybrid (Capacitor/Cordova)
 * ==========================================================
 *  CARA PASANG:
 ...
 *     TIDAK PERLU diubah sama sekali — semua fungsi di Code.gs
 ...
 *  seperti sebelumnya — Rpc.gs ini murni jembatan transport, tidak
...
var RPC_FUNCTIONS = {
  ...
  bulkAssignKurir: bulkAssignKurir,
...
// dari sisi client — supaya browser/WebView tidak mengirim preflight
